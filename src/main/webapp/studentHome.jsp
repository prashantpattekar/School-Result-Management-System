...
try{
	...
	String sql2 = "select * from student inner join result where student.rollNo=result.rollNo and student.rollNo='"+rollNo+"' ";
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>institution Name: UBDT</th>
          <th>Course Name:<%=res.getString(1) %></th>
          <th>Branch Name:<%=res.getString(2) %></th>
          <th><center>RollNo:<%=res.getString(3) %></center></th>
        </tr>
      </thead>
      <thead>
        <tr>
  ...
  <table>
    ...
    <tfoot>
      <tr>
        ...
        <td>560</td>
        <td>180</td>
        <td><% int sum = res.getInt(8)+res.getInt(9)+res.getInt(10)+res.getInt(11)+ res.getInt(12)+res.getInt(13)+res.getInt(14); out.println(sum);%> </td>
      </tr>
      <tr>
...
<%
		...
		response.sendRedirect("errorOneView.html");
	}
}
	catch(Exception e){
		out.println(e);
